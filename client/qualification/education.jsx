...
import React, { useState, useEffect } from "react";
import { list } from '../qualification/api-qualification.js';
import academic from '../src/assets/academic.jfif';
import '../src/education.css';
...
export default function Education() {
  ...
  return (
    <>
      ...
      {/* Display qualifications as side-looking cards */}
      <Grid container spacing={3} justifyContent="center" className="qualifications-container">
        {qualifications.map((q, index) => (
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card className="qualification-card">
              <CardContent>
                <Typography variant="h6">{q.title}</Typography>
                <Typography variant="body1">{q.firstname} {q.lastname}</Typography>
                <Typography variant="body2" className="email">{q.email}</Typography>
                <span className="completion-badge">Completion: {q.completion}</span>
